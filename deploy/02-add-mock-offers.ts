...
const deployFundSwap: DeployFunction = async function ({ deployments, getChainId }) {
  ...
  await fundswap.addTokenToWhitelist(mockUSDCAddress);
  await fundswap.addTokenToWhitelist(mockERC20Address);
